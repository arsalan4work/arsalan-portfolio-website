...
export const navItems = [
 ...
 export const gridItems = [
   ...
   {
     id: 6,
     title: "Do you want to start a project together? Copy the email below 👇",
     description: "",
     className: "lg:col-span-2 md:col-span-3 md:row-span-1",
     imgClassName: "",
 ...
 export const testimonials = [
  ...
  {
    quote:
      "Arsalan was a pleasure to work with—responsive, skilled, and committed to excellence. Our startup’s website is now more engaging and optimized for conversions, thanks to his expertise.",
    name: "Samantha Lopez",
