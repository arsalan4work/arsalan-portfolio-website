...
const RecentProjects = () => {
  return (
    <div className="py-10" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-5 lg:gap-[100px] mt-5">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className="lg:min-h-[40rem] h-[30rem] flex items-center justify-center
            sm:w-[450px] w-[80vw]"
          >
